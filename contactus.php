...
<div class="col-sm-5" align="center">
  ...
  <div class="form-group">
    <label for="pwd">Contact us with +94 000 12 12 0</label>
  </div>
   <div class="form-group">
    <label for="email">Email address : cargo@webmail.com</label>
  </div>
  <div class="form-group">
    <label for="email">Our home : 207/A,Rajagiriya Road,<br/> Colombo,Sri Lanka. </label>
  </div>
</form></div>
